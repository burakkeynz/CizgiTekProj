...
def upgrade():
    ...
    # The commented out alter_column code in your original downgrade() function
    # actually belongs in the downgrade() function of a different migration.
    # It seems like there was a copy-paste error.
