...
export default function ActiveCallOverlay({ socket, currentUser }) {
  ...
  // Debug için ekliyorum
  useEffect(() => {
    console.log("[Overlay DEBUG] inCall:", inCall);
    console.log("[Overlay DEBUG] peerUser:", peerUser);
    console.log("[Overlay DEBUG] callType:", callType);
    console.log("[Overlay DEBUG] panelRect:", panelRect);
    console.log("[Overlay DEBUG] retryCount:", retryCount);
  }, [inCall, peerUser, callType, panelRect, retryCount]);
